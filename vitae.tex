...
\resheading{Profile}
Professional C++ legacy paratrooper and spare time JavaScript hero seeking a higher level, role in technology. Strong abstract and analytical background in mathematics and teaching, plus a long history of developing modules for nodejs.
...
\begin{itemize}
  \item
    ...
    \begin{itemize}
      \resitem{C++ implementation and testing of various telepresence call control protocols, shared between a variety of scalable multipoint conferencing servers.}
...
\begin{itemize}
  \item
    ...
    \begin{itemize}
      ...
      \resitem{\emph{logule} - A highly tunable modular logger}
...
\begin{description}
  ...
  \item[Miscellaneous:] Python, PHP, CSS (SASS/stylus)
\end{description}
