...
\resheading{Profile}
Professional C++ legacy paratrooper and spare time JavaScript hero seeking a higher level, more functional, role in technology. Strong analytical background in mathematics and teaching, and a long history developing modules for nodejs.
...
\begin{description}
  ...
  \item[Databases:] CouchDB, SQL, Redis, MongoDB
